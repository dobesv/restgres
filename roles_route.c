...
void
jsonbuf_add_role_info(struct jsonbuf *jp, Oid oid, Form_pg_authid dbform);
...
jsonbuf_add_roles(struct jsonbuf *jp)
{
	...
	jsonbuf_member_start_array(jp, "roles");
	...
	while (HeapTupleIsValid(tuple = systable_getnext(scan)))
	{
		...
		jsonbuf_add_role_info(jp, oid, form);
